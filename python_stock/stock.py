...
num=0
if(os.path.exists('F:/workspace/pythontest/src/stock1.txt')):
    os.remove('F:/workspace/pythontest/src/stock1.txt')    
elif(os.path.exists('F:/workspace/pythontest/src/stock1.txt')):
    f=open('stock1.txt','w')  
